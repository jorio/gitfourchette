...
class Ui_CommitDialog(object):
    def setupUi(self, CommitDialog):
        ...
        self.buttonLayout.addWidget(self.signoffButton)
        self.gpg = GpgButton(parent=CommitDialog)
        self.gpg.setText("&GPG")
        self.gpg.setObjectName("gpg")
        self.buttonLayout.addWidget(self.gpg)
