...
class Ui_CommitDialog(object):
    def setupUi(self, CommitDialog):
        ...
        self.gpgHLayout = QHBoxLayout()
        self.gpgHLayout.setSpacing(0)
        self.gpgHLayout.setObjectName("gpgHLayout")
        self.gpgLabel = QLabel(parent=CommitDialog)
        self.gpgLabel.setEnabled(False)
        self.gpgLabel.setText("GPG")
        self.gpgLabel.setObjectName("gpgLabel")
        self.gpgHLayout.addWidget(self.gpgLabel)
        self.gpgCheckBox = QCheckBox(parent=CommitDialog)
        self.gpgCheckBox.setText("&GPG")
        self.gpgCheckBox.setObjectName("gpgCheckBox")
        self.gpgHLayout.addWidget(self.gpgCheckBox)
        self.gpgButton = QHintButton(parent=CommitDialog)
        self.gpgButton.setText("GPG")
        self.gpgButton.setAutoRaise(True)
        self.gpgButton.setObjectName("gpgButton")
        self.gpgHLayout.addWidget(self.gpgButton)
        self.buttonLayout.addLayout(self.gpgHLayout)
        spacerItem1 = QSpacerItem(4, 1, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, CommitDialog):
        CommitDialog.setWindowTitle(_p("CommitDialog", "Commit"))
