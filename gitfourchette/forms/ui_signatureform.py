...
class Ui_SignatureForm(object):
    ...
    def retranslateUi(self, SignatureForm):
        ...
        self.replaceComboBox.setToolTip(_p("SignatureForm", "<p>Every commit records information about an author and a committer. They can be the same person.</p>\n"
"       <p>Select which person you want to override.</p>"))
        self.replaceComboBox.setItemText(0, _p("SignatureForm", "Author"))
        self.replaceComboBox.setItemText(1, _p("SignatureForm", "Committer"))
        self.replaceComboBox.setItemText(2, _p("SignatureForm", "Both"))
