...
class Ui_CheckoutCommitDialog(object):
    def setupUi(self, CheckoutCommitDialog):
        ...
        self.detachHeadRadioButton = QRadioButton(parent=self.groupBox_2)
        self.detachHeadRadioButton.setObjectName("detachHeadRadioButton")
        self.verticalLayout_3.addWidget(self.detachHeadRadioButton)
        self.resetHeadRadioButton = QRadioButton(parent=self.groupBox_2)
        ...
        CheckoutCommitDialog.setTabOrder(self.switchToLocalBranchRadioButton, self.switchToLocalBranchComboBox)
        CheckoutCommitDialog.setTabOrder(self.switchToLocalBranchComboBox, self.detachHeadRadioButton)
        CheckoutCommitDialog.setTabOrder(self.detachHeadRadioButton, self.resetHeadRadioButton)
        CheckoutCommitDialog.setTabOrder(self.resetHeadRadioButton, self.createBranchRadioButton)
